...
public class ConnectionCreator {
    ...
    static {
        try {
            ...
            logger.error("FileNotFoundException in ConnectionCreator", e);
            throw new RuntimeException();
        } catch (IOException e) {
            logger.error("IOException in ConnectionCreator", e);
            throw new RuntimeException();
        } catch (ClassNotFoundException e) {
            logger.error("ClassNotFoundException in ConnectionCreator", e);
            throw new RuntimeException();
        }
    }
